                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        {!item.resumen &&
                          item.contenido_original && (
                            <p className="mt-3 line-clamp-3 text-sm leading-6 text-black">
                              {
                                item.contenido_original
                              }
                            </p>
                        ...
                        <div className="mt-4 flex flex-wrap gap-4 text-xs text-black">
...
function Estado({
  ...
  return (
    <span className="rounded-full border border-slate-400 bg-white px-3 py-1 text-xs text-black">
      Pendiente
    </span>
  );
}
