            ...
            <button
              ...
              className={`whitespace-nowrap rounded-full border px-4 py-2 text-sm font-medium transition ${
                filtroArea === area
                  ...
                  : "border-slate-400 bg-white text-black hover:bg-slate-100"
              }`}
            >
              {area}
            </button>
          ...
          {resultado.map((item) => {
            ...
            return (
              ...
              >
                ...
                <p className="mt-2 min-h-5 text-xs font-semibold uppercase tracking-wide text-black">
                  {item.area || "Sin área asignada"}
                </p>

                <div className="mt-5 flex items-center gap-2 border-t border-slate-400 pt-4 text-sm text-black">
                  <Users size={17} />
