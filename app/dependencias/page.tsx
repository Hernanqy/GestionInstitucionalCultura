          ...
          {resultado.map((item) => {
            ...
            return (
              ...
              >
                ...
                <p className="mt-2 min-h-5 text-xs font-semibold uppercase tracking-wide text-slate-950">
                  {item.area || "Sin área asignada"}
                </p>

                <div className="mt-5 flex items-center gap-2 border-t border-slate-400 pt-4 text-sm text-slate-950">
                  <Users size={17} />
