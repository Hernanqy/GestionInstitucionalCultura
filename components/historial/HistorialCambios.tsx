          ...
          {cambios.map((cambio) => (
            ...
            >
              ...
              <div className="mt-3 flex flex-col gap-2 text-sm md:flex-row md:items-center">
                ...
                <div className="rounded-lg border border-slate-400 bg-white px-3 py-2 text-black">
                  {valorTexto(
                ...
                <div className="rounded-lg border border-sky-200 bg-sky-100 px-3 py-2 text-black">
                  {valorTexto(
                    cambio.valor_nuevo
                  )}
                </div>
